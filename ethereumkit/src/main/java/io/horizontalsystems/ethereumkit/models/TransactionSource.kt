...
class TransactionSource(val name: String, val type: SourceType) {
    ...
    companion object {
        ...
        fun bscScanTest(apiKey: String): TransactionSource {
            return TransactionSource(
                "bscscan.com",
                SourceType.Etherscan("https://api-testnet.bscscan.com", "https://bscscan.com", apiKey)
            )
        }
        ...
        fun polygonScanTest(apiKey: String): TransactionSource {
            return TransactionSource(
                "polygonscan.com",
                SourceType.Etherscan("https://api-testnet.polygonscan.com", "https://polygonscan.com", apiKey)
            )
        }
